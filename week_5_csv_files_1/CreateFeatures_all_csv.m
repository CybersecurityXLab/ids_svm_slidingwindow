...
CSVFiles = dir(fullfile('C:','Users','User','Documents', 'GitHub', 'ids_svm_slidingwindow','week_5_csv_files_1', '*.csv'));
...
% Save output:
save ..\week_5_features_1\AllFeatures.mat AllFeatures
save ..\week_5_features_1\AllLabels.mat AllLabels
