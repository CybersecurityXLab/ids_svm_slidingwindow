...
CSVFiles = dir(fullfile('C:','Users','User','Documents', 'GitHub', 'ids_svm_slidingwindow','csv_files_1', '*.csv'));
...
% Save output:
save ..\features_1\AllFeatures.mat AllFeatures
save ..\features_1\AllLabels.mat AllLabels
