...
CSVFiles = dir(fullfile('C:','Users','User','Documents', 'GitHub', 'ids_svm_slidingwindow','week_5_csv_files_3', '*.csv'));
...
% Save output:
save ..\week_5_features_3\AllFeatures.mat AllFeatures
save ..\week_5_features_3\AllLabels.mat AllLabels
