...
CSVFiles = dir(fullfile('C:','Users','User','Documents', 'GitHub', 'ids_svm_slidingwindow','csv_files_4', '*.csv'));
...
% Save output:
save ..\features_4\AllFeatures.mat AllFeatures
save ..\features_4\AllLabels.mat AllLabels
