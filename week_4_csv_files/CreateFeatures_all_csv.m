...
CSVFiles = dir(fullfile('C:','Users','Casey','Documents', 'GitHub', 'ids_svm_slidingwindow','week_4_csv_files', '*.csv'));
...
% Save output:
save ..\week_4_features\AllFeatures.mat AllFeatures
save ..\week_4_features\AllLabels.mat AllLabels
