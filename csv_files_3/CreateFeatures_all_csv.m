...
CSVFiles = dir(fullfile('C:','Users','User','Documents', 'GitHub', 'ids_svm_slidingwindow','csv_files_3', '*.csv'));
...
% Save output:
save ..\features_3\AllFeatures.mat AllFeatures
save ..\features_3\AllLabels.mat AllLabels
